    ...
    <div className="min-h-screen w-full bg-[#F5F7FA] text-newera-dark-gray">
      ...
      <nav aria-label="Breadcrumb" className="max-w-6xl mx-auto px-6 pt-6 pb-2">
        <ol className="flex items-center gap-2 text-xs text-[#5F6F75] font-sans">
          ...
          <li className="text-newera-dark-gray font-semibold">Water Purification</li>
        </ol>
      </nav>
      ...
      <main className="max-w-6xl mx-auto px-6 pb-20 flex flex-col gap-16">
        ...
        <section className="relative rounded-3xl overflow-hidden bg-newera-dark-blue px-8 md:px-14 py-16 md:py-24 mt-4">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <h1 className="font-poppins font-extrabold text-3xl md:text-5xl lg:text-6xl leading-[1.1] text-white mb-6">
              Clean Water for{' '}
              <span className="text-[#082fa3]">Every Room</span>{' '}
              in Your Home
            </h1>
        ...
        <section>
          <div className="text-center mb-10">
            <span className="text-[11px] font-bold uppercase text-[#082fa3] tracking-widest block mb-2">Our Solutions</span>
            <h2 className="font-poppins font-bold text-3xl md:text-4xl text-newera-dark-gray">Our Water Purification Solutions</h2>
        ...
        <section className="bg-white border border-[#e5e5e5] rounded-3xl p-8 md:p-12 shadow-sm">
          <div className="text-center mb-10">
            <span className="text-[11px] font-bold uppercase text-[#082fa3] tracking-widest block mb-2">Why It Matters</span>
            <h2 className="font-poppins font-bold text-3xl md:text-4xl text-newera-dark-gray">Why Water Quality Matters</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="font-poppins font-bold text-3xl md:text-4xl text-newera-dark-gray">Water Purification — Your Questions Answered</h2>
          </div>
        ...
        <section className="bg-newera-dark-blue rounded-3xl px-8 md:px-16 py-14 text-center">
          <span className="text-[11px] font-bold uppercase text-[#082fa3] tracking-widest block mb-4">Start With a Test</span>
