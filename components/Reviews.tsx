  ...
  return (
    <section className="mt-8 mb-6">
      <div className="flex flex-col md:flex-row items-baseline justify-between mb-8 gap-4">
        ...
        <span className="text-xs font-bold uppercase tracking-widest text-[#ff5722] bg-[#ff572220]/30 px-3 py-1 rounded-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((_, idx) => (
          <div key={idx} className="bg-white border border-[#e5e5e5] rounded-3xl p-6 md:p-8 flex flex-col shadow-sm">
            ...
            <div className="border-t border-[#e5e5e5] pt-5 mt-auto">
              <span className="font-bold text-newera-dark-gray text-sm block font-poppins">Customer Testimonial</span>
