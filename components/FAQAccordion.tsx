...
function FAQRow({ question, answer }: FAQItem) {
  ...
  return (
    <div className="border border-[#E2E8F0] rounded-2xl bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow">
      <button
      ...
      >
        <span className="font-poppins font-bold text-base md:text-lg text-[#14324b] pr-4">
          {question}
        </span>
        <ChevronDown
      ...
      >
        <p className="text-[#5F6F75] text-sm md:text-base leading-relaxed font-sans border-t border-[#E2E8F0] pt-4 mt-1">
          {answer}
        </p>
      </div>
    </div>
  ...
  return (
    <section className="py-12 max-w-4xl mx-auto w-full">
      <div className="text-center mb-10">
        ...
        <h2 className="font-poppins font-bold text-2xl md:text-3xl text-[#14324b]">{title}</h2>
        {subtitle && (
