...
export function FAQ() {
  ...
  const faqsEn = [
    ...
    { question: "Will my Homeowners Association (HOA) allow solar panels?", answer: "Florida, Massachusetts, and Connecticut each have solar-access protections that may limit an HOA’s ability to prohibit or unreasonably restrict solar installations. HOAs may still have approval processes, design guidelines, or placement requirements, so our team helps homeowners review the requirements before moving forward." },
  ...
  const faqsEs = [
    ...
    { question: "\u00bfPermitir\u00e1 mi Asociaci\u00f3n de Propietarios (HOA) la instalaci\u00f3n de paneles?", answer: "Florida, Massachusetts y Connecticut cuentan cada uno con protecciones de acceso solar que pueden limitar la capacidad de una HOA para prohibir o restringir de manera irrazonable las instalaciones solares. Las HOA a\u00fan pueden tener procesos de aprobaci\u00f3n, pautas de dise\u00f1o o requisitos de ubicaci\u00f3n, por lo que nuestro equipo ayuda a los propietarios a revisar los requisitos antes de seguir adelante." },
